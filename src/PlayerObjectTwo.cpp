...
bool PlayerObjectTwo::LoadImg(std::string path, SDL_Renderer* screen){
...
SDL_Rect PlayerObjectTwo::GetRectFrame(){
    SDL_Rect rect;
    rect.x = rect_.x;
    rect.y = rect_.y;
    rect.w = width_frame;
...
void PlayerObjectTwo::CenterEntityOnMap(Map& map_data){
...
void PlayerObjectTwo::CheckCollideMap(Map& map_data){
    int x1 = 0;
    int x2 = 0;
...
std::string PlayerObjectTwo::HitState(){
